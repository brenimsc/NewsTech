...
class NoticiaRepository(
    ...
    fun buscaTodos() : LiveData<Resource<List<Noticia>?>> {
        ...
        val liveData = MutableLiveData<Resource<List<Noticia>?>>()
        buscaNaApi(
            quandoFalha = {erro ->
            liveData.value = Resource(dado = null, erro = erro)
        })

        mediador.addSource(liveData) {resourceDeFalha ->
    ...
    fun buscaPorId(noticiaId: Long): LiveData<Noticia?> {
        ...
        // antes de mudar o dao para LiveData e atualizar automatico
